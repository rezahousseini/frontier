...
//! \file mfa1List.h
//! \brief This class implements a generic template linked list 
//!        used by both the DR-Planner and the Solver

#ifndef INCLUDE_MFA1LIST_H
#define INCLUDE_MFA1LIST_H
