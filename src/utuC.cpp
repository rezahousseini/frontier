...
//! \file utuC.cpp
//! \brief The UTU (universal transfer unit)-- main controller program for
//!        FRONTIER
                   ...
                   jdoubleArray arrDbl, jcharArray arrChar)
{
  ...
  switch(flag)
    {
      ...
      case 3:
        startI=2;
		  	...
		  	loadState (graph1, graph0, SolverTrees, startI, dataInt, startF, 
                   dataDouble, dataChar);
  ...
  // Solver subroutine
  Solver(graph1, graph0, DRTrees, dataInt, dataDouble, dataChar, Tree);
